# Gennemgang af villager-retask-segmentet

Denne note gennemgår **det aktuelle segment** i den omdøbte workflow-fil og deler det op i mindre, forståelige undersegmenter.

Målet er ikke at forklare hver enkelt kommando syntaktisk, men at forklare **hvad hver blok prøver at opnå**, **hvordan den hænger sammen med resten af flowet**, og **hvilke eksterne inputs den stadig afhænger af**.
...
- hvis en villager allerede er en “god nok” food-villager, bliver den ikke nødvendigvis flyttet
- det samme gælder de andre ressourcer efter normalisering
...
### Hvorfor det er vigtigt for resten
Hvis AI'en skal vælge et godt nyt arbejdssted, skal den først definere **hvilket område omkring villageren** der er relevant. Denne radius styrer hvilke bygninger/farms/dropoffs der overhovedet bliver overvejet senere.
...
Et “anker” er her det sted, der giver geografisk struktur til søgningen, f.eks.:
- lumber camp
- mining camp
- mule cart
- farm
...
### Hvorfor det er vigtigt for resten
Denne blok afgør **hvilken geografi motoren bruger**. Det er forskellen på:
- “find en ny wood-opgave omkring lumber camps”
- “brug town center som fallback for wood”
- “brug farms/mills/TC til food”
...
Det er altså den del af motoren der vælger **hvor** den næste rigtige resource-søgning skal ske.

### Eksterne inputs brugt her
Ingen af de kendte eksterne inputs er centrale her; logikken bruger primært internt beregnede scoring-goals.
...
### Hvorfor det er vigtigt for resten
Retask-motoren slutter altså ikke bare med “mislykkedes”. Den kan først prøve en lille TC/garrison-oprydning, som kan hjælpe fastlåste villagers videre.
...
### Eksterne inputs brugt her
Ingen af de kendte eksterne inputs bruges direkte i selve kæden; den kalder primært retask-motoren gentagne gange med forskellige mål.
